...
public class Test {
    ...
    public void test4Merge() {
        ...
        MergeSort mysort = new MergeSort(arr);
        assertArrayEquals(ans, mysort.getResult());
        mysort.getTime("src/worstCase.txt");
    }
    ...
    public void test3Count() {
        int[] arr = getInput("src/10000up1.txt");
        CountingSort mysort = new CountingSort(arr);
        mysort.sort();
    ...
    public void test1Heap() {
        ...
        hs.getTime("src/averageCase.txt");
    }
    ...
    public void testAll2() throws IOException {
        HeapSort hs = new HeapSort();
        int[] arr = getInput("src/10000n1.txt");
        MergeSort ms = new MergeSort(arr);
    ...
    public void testAll3() throws IOException {
        HeapSort hs = new HeapSort();
        int[] arr = getInput("src/20000n1.txt");
        MergeSort ms = new MergeSort(arr);
        CountingSort cs = new CountingSort(arr);
        cs.sort();
        InsertionSort is = new InsertionSort();
    ...
    public void testAll4() throws IOException {
        ...
        assertArrayEquals(ms.getResult(), temp);
        ms.getTime("src/bestCase.txt");
        is.getTime("src/bestCase.txt");
        cs.getTime("src/bestCase.txt");
        // call get time here
    }
